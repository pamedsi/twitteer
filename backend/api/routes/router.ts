...
import { login } from './../../userAuthenticator/userAuthenticatorController.js';
import { userJWTValidator } from './../../userAuthenticator/userJWTValidator.js';
...
router.post('/login', userJWTValidator, login)
